...
public record HolidaySearchRequest(
        ...
        @Schema(description = "조회할 연도", example = "null")
        Integer year,
        ...
        @Schema(description = "로컬 공휴일 이름", example = "새해")
        String localName,

        @Schema(description = "국가 코드", example = "KR")
        String countryCode,

        @Schema(description = "고정 날짜 여부 (true: 매년 같은 날짜)", example = "false")
        Boolean fixed,

        @Schema(description = "글로벌 공휴일 여부", example = "true")
        Boolean global,

        @Schema(description = "공휴일이 최초 도입된 연도", example = "null")
        Integer launchYear,
